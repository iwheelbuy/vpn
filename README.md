...
# To be replaced: LIGHTSAIL_SERVER_IP_OR_DOMAIN, LIGHTSAIL_ACCESS_CERT, LIGHTSAIL_CERT_NAME, MIKROTIK_IPSEC_NAMESPACE, LIGHTSAIL_BRANCH_NAME
...
./step2.sh LIGHTSAIL_SERVER_IP_OR_DOMAIN > vpn.mobileconfig
exit
exit
